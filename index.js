...
bot.command("start", async (ctx) => {
  const welcomeMessage =
    '<b>Hello! I am Spotify Downloader Bot 🎶</b>\n\nI ᴄᴀɴ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ sᴏɴɢ ғʀᴏᴍ Sᴘᴏᴛɪғʏ ᴀɴᴅ sᴇɴᴅ ɪᴛ ᴛᴏ ʏᴏᴜ ᴀs ᴀɴ ᴀᴜᴅɪᴏ ғɪʟᴇ.\n\nJᴜsᴛ sᴇɴᴅ ᴍᴇ ᴛʜᴇ Sᴘᴏᴛɪғʏ sᴏɴɢ URL ʟɪᴋᴇ ᴛʜɪs /download SONG_URL ᴏʀ ᴜsᴇ ᴛʜᴇ /search ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ sᴇᴀʀᴄʜ ғᴏʀ ᴀ sᴏɴɢ ᴀɴᴅ ᴅɪʀᴇᴄᴛʟʏ ᴅᴏᴡɴʟᴏᴀᴅ ɪᴛ.\n⁉️ Fᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ᴜsᴇ ᴛʜᴇ /help ᴄᴏᴍᴍᴀɴᴅ.\n\n🗑️ <i>Feel free to delete message to keep our chat clean and focused on music!</i>\n\n<b>🎵 Make your bot @INFO_AIMBOT</b>';
